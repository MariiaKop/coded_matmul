...
from dist_mm.codes.orthopoly import encode_cheb_matrix, recovery_matrix_cheb_Strassen
...
if RANK == 0:
    ...
    S_tilda = encode_cheb_matrix(S, N, 1)
    Q_tilda = encode_cheb_matrix(Q, N, m)
    ...
    P_rec = recovery_matrix_cheb_Strassen(P_tilda, N, m, n, saved_nodes, l, p)

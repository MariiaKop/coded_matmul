...
from dist_mm.codes.poly import encode_poly_matrix, recovery_matrix_poly_Strassen
...
if RANK == 0:
    ...
    S_tilda = encode_poly_matrix(S, N, 1)
    Q_tilda = encode_poly_matrix(Q, N, m)
    ...
    P_rec = recovery_matrix_poly_Strassen(P_tilda, N, m, n, saved_nodes, l, p)
